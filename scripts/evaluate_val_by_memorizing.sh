...
ALPHA=0.5
MODEL_DIR=models/original_alpha0.5
FOLDER=GOTURN1_val
...
build/test_tracker_alov_by_memorizing $VIDEOS_FOLDER $ANNOTATIONS_FOLDER $DEPLOY_PROTO $CAFFE_MODEL $OUTPUT_FOLDER $ALPHA $USE_TRAIN $SAVE_VIDEOS $GPU_ID 
